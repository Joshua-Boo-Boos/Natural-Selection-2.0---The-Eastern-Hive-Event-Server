...
local kPunchSoundLeft = PrecacheAsset("sound/ns2plus.fev/common/marine/onos_punch_l")
local kPunchSoundRight = PrecacheAsset("sound/ns2plus.fev/common/marine/onos_punch_r")
