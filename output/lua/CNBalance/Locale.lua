...
local isZHCN = Client.GetOptionString( "locale", "enUS" ) == "zhCN"

local baseResolveString = Locale.ResolveString
function CNLocalizeResolve(input)
    if not input then return "" end

    local resolvedString = isZHCN and rawget(kTranslateMessage,input) or rawget(kLocales,input)
...
kTranslateMessage["RESPAWN_EXTEND_TEAM1"] = "增援耗时 [%.2f秒]"
kTranslateMessage["DEADLOCK_UNTIL_TEAM1"] = "站点接管 [%i:%02i] 倒计时[%i:%02i]"
kTranslateMessage["DEADLOCK_ACTIVATED_TEAM1"] = "站点清理 [%i:%02i] 站点自毁[%i:%02i]"
kTranslateMessage["DEADLOCK_ACTIVATING_TEAM1"] = "站点自毁协议已启用,立即压制污染指标."
...
kTranslateMessage["KNIFE_BUYDESCRIPTION"]="战斗匕首。\n对敌方实体造成30点轻型伤害。\n被吞噬时造成80点伤害。"
...
kTranslateMessage["PROWLER_EGG"] = "Prowler egg"
kTranslateMessage["PROWLER_EGG_TOOLTIP"] = "Creates an egg that a Prowler can spawn from"
...
kTranslateMessage["VOKEX_EGG"] = "Vokex egg"
kTranslateMessage["VOKEX_EGG_TOOLTIP"] = "Creates an egg that a Vokex can spawn from"
...
-- Prototype-Exo scoreboard combo names.  "…_PLUS" = same name + "+" (Exo has any
-- Experimental Technology upgrade).  zhCN variants below in kTranslateMessage.
-- Short forms to avoid scoreboard clipping: MG (Minigun), RG (Railgun), FT (Flamethrower).
kLocales["STATUS_EXO_DUAL_MINIGUN"] = "Dual-MG Exo"
kLocales["STATUS_EXO_DUAL_RAIL"]    = "Dual-RG Exo"
kLocales["STATUS_EXO_DUAL_FT"]      = "Dual-FT Exo"
kLocales["STATUS_EXO_CLAW_MINIGUN"] = "Claw/MG Exo"
kLocales["STATUS_EXO_CLAW_RAIL"]    = "Claw/RG Exo"
kLocales["STATUS_EXO_CLAW_FT"]      = "Claw/FT Exo"
kLocales["STATUS_EXO_DUAL_MINIGUN_PLUS"] = "Dual-MG Exo+"
kLocales["STATUS_EXO_DUAL_RAIL_PLUS"]    = "Dual-RG Exo+"
kLocales["STATUS_EXO_DUAL_FT_PLUS"]      = "Dual-FT Exo+"
kLocales["STATUS_EXO_CLAW_MINIGUN_PLUS"] = "Claw/MG Exo+"
kLocales["STATUS_EXO_CLAW_RAIL_PLUS"]    = "Claw/RG Exo+"
kLocales["STATUS_EXO_CLAW_FT_PLUS"]      = "Claw/FT Exo+"

kTranslateMessage["STATUS_EXO_DUAL_MINIGUN"] = "双重机枪外骨骼"
kTranslateMessage["STATUS_EXO_DUAL_RAIL"]    = "双重轨道炮外骨骼"
kTranslateMessage["STATUS_EXO_DUAL_FT"]      = "双重喷火外骨骼"
kTranslateMessage["STATUS_EXO_CLAW_MINIGUN"] = "利爪机枪外骨骼"
kTranslateMessage["STATUS_EXO_CLAW_RAIL"]    = "利爪轨道炮外骨骼"
kTranslateMessage["STATUS_EXO_CLAW_FT"]      = "利爪喷火外骨骼"
kTranslateMessage["STATUS_EXO_DUAL_MINIGUN_PLUS"] = "双重机枪外骨骼+"
kTranslateMessage["STATUS_EXO_DUAL_RAIL_PLUS"]    = "双重轨道炮外骨骼+"
kTranslateMessage["STATUS_EXO_DUAL_FT_PLUS"]      = "双重喷火外骨骼+"
kTranslateMessage["STATUS_EXO_CLAW_MINIGUN_PLUS"] = "利爪机枪外骨骼+"
kTranslateMessage["STATUS_EXO_CLAW_RAIL_PLUS"]    = "利爪轨道炮外骨骼+"
kTranslateMessage["STATUS_EXO_CLAW_FT_PLUS"]      = "利爪喷火外骨骼+"
...
kLocales["DEADLOCK_UNTIL_TEAM2"] = "Infesting [%i:%02i->%i:%02i]"
kLocales["DEADLOCK_ACTIVATED_TEAM2"] = "Bio-link Degenerating [%i:%02i->%i:%02i]"
kLocales["DEADLOCK_ACTIVATING_TEAM2"] = "Hive Bio-link Degenerating,Expand Region ASAP."
...
-- Key was ARMOR_SUPPLY_HINT, but the button looks up ARMOR_SUPPLY_TOOLTIP (as every other supply
-- branch does), so with no matching entry the raw key "ARMOR_SUPPLY_TOOLTIP" was shown instead of
-- text. Renamed to match, and rewritten in the same style as ELECTRONIC_SUPPLY_TOOLTIP: what the
-- upgrade does, then ">" for what it unlocks, then "+" for the passive it grants. The Chinese line
-- (kTranslateMessage) is kept identical in meaning, line for line.
kLocales["ARMOR_SUPPLY_TOOLTIP"] = "Upgrade to equipment base.\n>Nano Armor & Nano Shield.\n+Regen health after combat."
...
kLocales["EXPLOSIVE_SUPPLY_TOOLTIP"] = "Upgrade to combustible base.\n>Deploy Mine & GL capability.\n+Mines less visible to Kharaa."
...
kLocales["ELECTRONIC_SUPPLY_TOOLTIP"] = "Upgrade to electronic base.\n>Unlock extractor upgrades.\n+Extractors shock attackers."
...
kLocales["KNIFE_BUYDESCRIPTION"]="Combat Knife.\n30 light damage to enemy entities.\nDeals 80 damage while being devoured."
...
kLocales["GRENADES_TOOLTIP"]= "+Unlock hand grenades." -- "+Unlock new grenade types.\nMarines throw grenades faster."
...
kLocales["PROWLER_EGG"] = "Prowler egg"
kLocales["PROWLER_EGG_TOOLTIP"] = "Creates an egg that a Prowler can spawn from"
...
kLocales["VOKEX_EGG"] = "Vokex egg"
kLocales["VOKEX_EGG_TOOLTIP"] = "Creates an egg that a Vokex can spawn from"
...
kLocales["PRIMAL_SCREAM"] = "Primal Scream"
kLocales["PRIMAL_SCREAM_TOOLTIP"] = "Rally nearby allied aliens with a partial enzyme buff that boosts attack speed.\n*Skips allies that are already enzymed.\n*Real enzyme applied later overrides Primal Scream."
kLocales["TUNNEL_RELOCATE_TOOLTIP"] = "Relocate this side of the tunnel to another location."
