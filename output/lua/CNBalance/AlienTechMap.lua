...
kAlienTechMap =
{
    ...
    {kTechId.BoneWall, 3.5, 7},         { kTechId.BioMassThree, 3.5, 8, nil, "3" }, { kTechId.BileBomb, 3.5, 9 },{ kTechId.Devour, 3.5, 10},
                                        ...
                                        { kTechId.BioMassFive, 5.5, 8, nil, "5" }, { kTechId.BoneShield, 5.5, 9}, { kTechId.MetabolizeHealth, 5.5, 10},{kTechId.AcidSpray, 5.5, 11},
                                        { kTechId.BioMassSix, 6.5, 8, nil, "6" },  { kTechId.Umbra, 6.5, 9}, {kTechId.AcidRocket, 6.5, 10},
                                        { kTechId.BioMassSeven, 7.5, 8, nil, "7" }, { kTechId.Xenocide, 7.5, 9},{kTechId.Stab, 7.5, 10},
                                        { kTechId.BioMassEight, 8.5, 8, nil, "8" }, { kTechId.Stomp, 8.5, 9},{kTechId.VortexShadowStep, 8.5, 10 }, { kTechId.PrimalScream, 8.5, 11 },
