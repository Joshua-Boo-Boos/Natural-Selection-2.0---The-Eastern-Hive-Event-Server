...
local function UpdateItemsGUIScale(self)
	...
	GUIAlienBuyMenu.kAlienTypes = {
		{ LocaleName = Locale.ResolveString("GORGE"), Name = "Gorge", Width = GUIScale(200), Height = GUIScale(167), XPos = 1, Index = 1 },
		{ LocaleName = Locale.ResolveString("SKULK"), Name = "Skulk", Width = GUIScale(240), Height = GUIScale(170), XPos = 2, Index = 2 },
		{ LocaleName = "Prowler", Name = "Prowler", Width = GUIScale(240), Height = GUIScale(170), XPos = 3, Index = 3 },
		{ LocaleName = Locale.ResolveString("LERK"), Name = "Lerk", Width = GUIScale(284), Height = GUIScale(253), XPos = 4, Index = 4 },
		{ LocaleName = Locale.ResolveString("FADE"), Name = "Fade", Width = GUIScale(188), Height = GUIScale(220), XPos = 5, Index = 5 },
		{ LocaleName = "Vokex", Name = "Vokex", Width = GUIScale(210), Height = GUIScale(260), XPos = 6, Index = 6 },
		{ LocaleName = Locale.ResolveString("ONOS"), Name = "Onos", Width = GUIScale(304), Height = GUIScale(326), XPos = 7, Index = 7 }, }
...
function GUIAlienBuyMenu:Initialize()
	...
	self.backgroundCircle:SetIsVisible(not minimal)
