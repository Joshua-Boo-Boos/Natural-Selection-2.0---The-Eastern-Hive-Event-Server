...
debug.appendtoenum(kTechId, "MarineSentry")
...
debug.appendtoenum(kTechId, "Poison")

--Vokex ?
debug.appendtoenum(kTechId, "Vokex")
debug.appendtoenum(kTechId, "VokexMenu")
debug.appendtoenum(kTechId, "VokexEgg")
debug.appendtoenum(kTechId, "HallucinateVokex")
debug.appendtoenum(kTechId, "SwipeShadowStep")
debug.appendtoenum(kTechId, "MetabolizeShadowStep")
--debug.appendtoenum(kTechId, "MetabolizeShadowStepHealth")
