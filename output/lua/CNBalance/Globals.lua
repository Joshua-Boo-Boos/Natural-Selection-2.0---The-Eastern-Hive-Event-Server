...
local kEndGameBegin = 2400 -- Was 1500 - Is this meant to be the default Base Decay / Deadlock start time?
local kEndGameTolerance = 600 -- What is this actually for?
...
function GetRespawnTimeExtend(player,teamIndex, _gameLength)
    ...
    return math.min(respawnExtension + teamExtension, 11) -- respawnExtension + teamExtension
end